...
Route::post('loans/reports_filter', 'LoansController@reports_filter')->middleware('auth:api');
...
//Loans transactions
Route::get('loans_payments/showall', 'LoanPaymentsController@showitall');
Route::resource('loans_payments', 'LoanPaymentsController');
